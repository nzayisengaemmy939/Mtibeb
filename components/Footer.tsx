              ...
              <div className="relative p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-blue-500/10 backdrop-blur-sm border border-white/10 hover:border-orange-400/30 transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  <div className="relative">
                    <TreeIcon
                      className={`w-8 h-8 text-green-400 transition-all duration-300 ${
                        activeSection === "brand" ? "rotate-12 scale-110" : ""
                      }`}
                    />
                    <Sparkles
                    ...
                    (item, index) => (
                      ...
                      >
                        <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 transition-all duration-200">
                          <div
                            className={`w-2 h-2 rounded-full bg-orange-400 transition-all duration-300 ${
                              activeSection === "nav" ? "scale-100" : "scale-0"
                            }`}
                          ></div>
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    >
                      <div className="relative">
                        <Icon
                          className={`w-5 h-5 text-gray-400 group-hover/social:scale-125 transition-all duration-300 ${color}`}
                        />
                        <div
                          className={`absolute inset-0 bg-current rounded-full opacity-0 group-hover/social:opacity-20 group-hover/social:scale-150 transition-all duration-300`}
                        ></div>
                      </div>
                      <span
                        className={`text-sm text-gray-400 group-hover/social:text-white transition-colors duration-200 ${color.replace(
                          "hover:",
                          ""
                        )}`}
                      >
          ...
          <div className="relative">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex items-center gap-2 text-sm text-gray-400">
                <TreePine className="w-4 h-4 text-green-400" />
                <span>
                  &copy; {new Date().getFullYear()} Miti Tibeb. Crafted with
                </span>
