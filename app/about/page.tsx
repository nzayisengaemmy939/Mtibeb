...
export default function AboutUs() {
  ...
  const InteractiveStats = ({ stats, color }) => (
      ...
      <section className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-[#1A1A2E] via-[#16213E] to-[#0F0F23]">
        ...
        <div className="text-center z-10 max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl md:text-2xl text-white/80 mb-12 leading-relaxed">
            ...
            showcase not only the manufacturing talent of our partners but also
            their expert installation work — bringing peace and beauty into your
            spaces.
          </p>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-lg">{section.subtitle}</p>
                  </div>
                </div>
                ...
                <InteractiveStats stats={section.stats} color={section.color} />
              </div>
